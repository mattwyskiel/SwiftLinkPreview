...
class Regex {
    ...
    static func pregMatchFirst(_ string: String!, regex: String!, index: Int = 0) -> String? {
        ...
        do{
            ...
            let rx = try RegularExpression(pattern: regex, options: [.caseInsensitive])
    ...
    static func pregMatchAll(_ string: String!, regex: String!, index: Int = 0) -> [String] {
        ...
        do{
            ...
            if let matches: [TextCheckingResult] = rx.matches(in: string, options: [], range: NSMakeRange(0, string.characters.count)) {
    ...
    static func stringMatches(_ results: [TextCheckingResult], text: String, index: Int = 0) -> [String] {
